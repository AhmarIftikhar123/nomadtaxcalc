...
class TaxCalculatorController extends Controller
{
  ...
  {
    // IMPORTANT: noindex prevents Google penalising the site for thousands
    // of unique share-token URLs with identical/thin content.
